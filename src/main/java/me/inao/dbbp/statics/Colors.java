package me.inao.dbbp.statics;

import me.inao.dbbp.lentils.HttpDriver;
...
public class Colors {
    ...
    public static final String COLOR_RANDOM = "#" + new HttpDriver().getRequestWithoutResponse(Links.QRNG_RANDOM_HEXCOLOR);
}
